...
// Os PIPELINES tambem ensinam comandos, e o erro sobreviveu ali.
//
// A v0.1.121 corrigiu `anchors claim` no guia -- mas o gate de coluna continuava
// mandando rodar o mesmo comando inexistente, e num momento pior: dentro da
// mensagem de erro, para quem acabou de ser BARRADO. Quem fosse seguir a instrucao
// receberia `unknown command` no momento em que mais precisava de uma saida.
//
// A regua do guia nao pegava porque olhava so o guia. Esta olha os YAML embutidos.
