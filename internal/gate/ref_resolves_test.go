...
func TestRefResolvesCodeMissingFromTheProject(t *testing.T) {
	t.Run("RFRSR-B14: A reference to a code that exists nowhere fails", func(t *testing.T) {})
...
func TestRefResolvesNoSiblingSpecButCodeExists(t *testing.T) {
	t.Run("RFRSR-B15: Without sibling spec, an existing code still skips", func(t *testing.T) {})
...
func TestRefResolvesInferredIdentityDoesNotCount(t *testing.T) {
	t.Run("RFRSR-B16: An inferred identity does not satisfy the reference", func(t *testing.T) {})
...
func TestRefResolvesWithoutGraphDoesNotAssertAbsence(t *testing.T) {
	t.Run("RFRSR-B17: Without a graph, absence is not asserted", func(t *testing.T) {})
	v, _ := runRefResolvesWithGraph(t, "x.ts", "// @anchors\n//   ref: QUALQ\n", nil)
	if v != Skip {
